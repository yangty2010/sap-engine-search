...
<link rel="stylesheet" href="${ctx }/views/pdf/viewer.css" />

<script type="text/javascript" src="${ctx }/views/pdf/compatibility.js"></script>



<!-- This snippet is used in production, see Makefile -->
<link rel="resource" type="application/l10n" href="${ctx }/views/pdf/locale/locale.properties" />
<script type="text/javascript" src="${ctx }/views/pdf/l10n.js"></script>
<script type="text/javascript" src="${ctx }/pdfjs/pdf.js"></script>
<script type="text/javascript">
	var DEFAULT_URL = "${ctx }/file/show?fileKey=${fileKey}";
</script>

<script type="text/javascript" src="${ctx }/views/pdf/debugger.js"></script>
<script type="text/javascript" src="${ctx }/views/pdf/viewer.js"></script>
    ...
    <div id="outerContainer" class="loadingInProgress">
        ...
        <div id="mainContainer">
            <div class="findbar hidden doorHanger hiddenSmallView" id="findbar">
                <label for="findInput" class="toolbarLabel" data-l10n-id="find_label">Find:</label> <input
                    id="findInput" class="toolbarField" tabindex="41">
                ...
                <input type="checkbox" id="findHighlightAll" class="toolbarField"> <label for="findHighlightAll"
                    class="toolbarLabel" tabindex="44" data-l10n-id="find_highlight">Highlight all</label> <input
                    type="checkbox" id="findMatchCase" class="toolbarField"> <label for="findMatchCase"
                    class="toolbarLabel" tabindex="45" data-l10n-id="find_match_case_label">Match case</label> <span
            ...
            <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
                <div id="secondaryToolbarButtonContainer">
                    ...
                    <a href="#" id="secondaryViewBookmark" class="secondaryToolbarButton bookmark visibleSmallView"
                        title="Current view (copy or open in new window)" tabindex="22" data-l10n-id="bookmark"> <span
                    ...
                    <button id="lastPage" class="secondaryToolbarButton lastPage" title="Go to Last Page" tabindex="24"
                ...
                <div id="toolbarContainer">
                    <div id="toolbarViewer">
                        <div id="toolbarViewerLeft">
                            ...
                            </label> <input type="number" id="pageNumber" class="toolbarField pageNumber" value="1" size="4"
                                min="1" tabindex="8"> </input> <span id="numPages" class="toolbarLabel"></span>
                        </div>
                        ...
                        <div class="outerCenter">
                            <div class="innerCenter" id="toolbarViewerMiddle">
                                ...
                                <span id="scaleSelectContainer" class="dropdownToolbarButton"> <select
                                    id="scaleSelect" title="Zoom" tabindex="11" data-l10n-id="zoom">
                                        ...
                                        <option id="pageFitOption" value="page-fit" data-l10n-id="page_scale_fit">Fit
                                            Page</option>
        ...
        <div id="overlayContainer" class="hidden">
            <div id="promptContainer">
                <div id="passwordContainer" class="prompt doorHanger">
                    ...
                    <div class="row">
                        <button id="passwordCancel" class="promptButton">
                            <span data-l10n-id="password_cancel">Cancel</span>
                        </button>
                        <button id="passwordSubmit" class="promptButton">
